...
#ifndef __AI_SAMPLE_CLASSIFICATION_H__
#define __AI_SAMPLE_CLASSIFICATION_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_SAMPLE_CLASSIFICATION_MODEL_NAME          "sample_classification"

#define AI_SAMPLE_CLASSIFICATION_ACTIVATIONS_ALIGNMENT   (4)

#define AI_SAMPLE_CLASSIFICATION_IN_NUM       (1)
#define AI_SAMPLE_CLASSIFICATION_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 28, 28, 1, 1, NULL), \
}
#define AI_SAMPLE_CLASSIFICATION_IN_SIZE { \
  (28 * 28 * 1), \
}
#define AI_SAMPLE_CLASSIFICATION_IN_1_SIZE  (28 * 28 * 1)
#define AI_SAMPLE_CLASSIFICATION_IN_1_SIZE_BYTES  ((28 * 28 * 1) * 4)





#define AI_SAMPLE_CLASSIFICATION_OUT_NUM      (1)
#define AI_SAMPLE_CLASSIFICATION_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 10, 1, NULL), \
}
#define AI_SAMPLE_CLASSIFICATION_OUT_SIZE { \
  (1 * 1 * 10), \
}
#define AI_SAMPLE_CLASSIFICATION_OUT_1_SIZE  (1 * 1 * 10)
#define AI_SAMPLE_CLASSIFICATION_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)

#define AI_SAMPLE_CLASSIFICATION_N_NODES (7)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup sample_classification
 ...
 * @ref ai_sample_classification_create. Both the activations memory buffer 
 ...
 * using @ref ai_sample_classification_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_SAMPLE_CLASSIFICATION_*
 * defines into file @ref sample_classification.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sample_classification_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_SAMPLE_CLASSIFICATION_H__*/
